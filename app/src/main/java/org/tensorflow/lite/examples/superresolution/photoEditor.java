...
public class photoEditor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(photoEditor.this,R.style.Theme_AppCompat_Dialog_Alert);
    ...
    private void showAlert(){
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(photoEditor.this,R.style.Theme_AppCompat_Dialog_Alert).create();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "ALLOW", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                ActivityCompat.requestPermissions(photoEditor.this,new String[]{Manifest.permission.CAMERA},MY_PERMISSION_REQUEST_CAMERA);
            }
        });
        alertDialog.show();
    ...
    private void showSettingsAlert(){
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(photoEditor.this,R.style.Theme_AppCompat_Dialog_Alert).create();
        alertDialog.setTitle("Alert");
        alertDialog.setMessage("App needs to access the Camera.");
        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "DON'T ALLOW", new DialogInterface.OnClickListener() {
            @Override
                ...
                for(int i=0,len=permissions.length;i<len;i++){
                    ...
                    if(grantResults[i]== PackageManager.PERMISSION_DENIED){
                        ...
                        if(showRationale){showAlert();}
                            ...
                            // the app setting
                            saveToPreferences(photoEditor.this,ALLOW_KEY,true);
                        }
                    }
                }
                break;
                ...
                for(int i=0,len=permissions.length;i<len;i++){
                    ...
                    if(grantResults[i]==PackageManager.PERMISSION_DENIED){
                        ...
                        if(showRationale){showAlert();}
                            ...
                            // again the permission and directing to
                            // the app setting
                            saveToPreferencesG(photoEditor.this,ALLOW_KEY,true);
                        }
                    }
                }
        }
    ...
    private void openCamera(){
        ...
        if(intent.resolveActivity(getPackageManager())!=null){
            ...
            if(photoFile != null){
                Uri photoURI = FileProvider.getUriForFile(photoEditor.this,"org.tensorflow.lite.examples.android.fileprovider",photoFile);
    ...
    protected void onActivityResult(int requestCode,int ResultCode,Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && ResultCode == Activity.RESULT_OK) {
            ...
            Intent i = new Intent(photoEditor.this, Image_Display_Activity.class);
    ...
    public void checkPermC(){
        ...
        if(ContextCompat.checkSelfPermission(photoEditor.this, Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED){
            if(getFromPref(this,ALLOW_KEY)){showSettingsAlert();}
            else if(ContextCompat.checkSelfPermission(photoEditor.this,Manifest.permission.CAMERA)!=PackageManager.PERMISSION_GRANTED){
                //should we show an explanation?
                if(ActivityCompat.shouldShowRequestPermissionRationale(photoEditor.this,Manifest.permission.CAMERA)){showAlert();}
                else {
    ...
    private void showAlertG(){
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "ALLOW", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                ActivityCompat.requestPermissions(photoEditor.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},MY_PERMISSION_REQUEST_STORE);
            }
        });
        alertDialog.show();
