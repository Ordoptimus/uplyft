...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    outputImage = findViewById(R.id.secondpreview);
    ...
    enhancebutton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            final ImageView superResolutionImageView = findViewById(R.id.secondpreview);  //superResolutionImageView
            final ImageView nativelyScaledImageView = findViewById(R.id.thirdpreview);
            /*
            ...
            //superResolutionImageView.setImageDrawable(null);  //setImageDrawable or setImageResource (with r.id)
            Bitmap srImgBitmap =
                Bitmap.createBitmap(
                    superResRGB, SR_IMAGE_WIDTH, SR_IMAGE_HEIGHT, Bitmap.Config.ARGB_8888);
            superResolutionImageView.setImageBitmap(srImgBitmap);  //or outputImage
            nativelyScaledImageView.setImageBitmap(selbitmap);
            //resultLayout.setVisibility(View.VISIBLE);
            //logTextView.setText("Inference time: " + processingTimeMs + "ms");

            superResolutionImageView.setVisibility(View.VISIBLE);  //outputImage
          }
        });
  }
